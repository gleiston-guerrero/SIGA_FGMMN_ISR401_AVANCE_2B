...
\url{https://github.com/gleiston-guerrero/SIGA_FGMMN_ISR401_AVANCE_2B}
\vspace{6mm}

{\bfseries VERSI\'ON DE ESTE DOCUMENTO:\par}
\vspace{2mm}
Versi\'on \textbf{4.11} \textbar\ 16/09/2026 \textbar\ sobre el commit \texttt{15cfc93}\\
L\'inea base etiquetada \texttt{2B-final-v5.12} en el repositorio declarado arriba.
\vspace{8mm}
...
dieciseis casos de uso, treinta y ocho historias de usuario con criterios de aceptacion en
...
verification method, together with sixteen use cases, thirty-eight user stories with
