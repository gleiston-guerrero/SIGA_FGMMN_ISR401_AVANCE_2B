...
| Etiquetas `2B-final-v5.0`, `2B-final-v5.1` y `2B-final-v5.2`, y caratulas | Claude (Anthropic) | Creacion de las etiquetas anotadas sobre el commit entregado y regeneracion de la caratula con `generar_caratula.py` | Ninguna etiqueta publicada se movio ni se borro; cada una se comprobo en el remoto. **La decision de cual es la vigente es del equipo** |
