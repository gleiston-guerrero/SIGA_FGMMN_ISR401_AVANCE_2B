...
| 6 | 2026-09-12 | La guía preveía ejecutar el modelo con una consigna literal sobre el material fuente. El Conjunto A se generó dentro de la conversación de trabajo del proyecto, a partir de la instrucción «usa tu propio modelo», aplicando esa tarea | Se documenta al localizarse la conversación en la exportación de claude.ai. No cambia ningún dato, puntuación ni resultado; su efecto sobre la validez es la exposición previa del modelo, declarada como amenaza de constructo desde el 2026-08-02 | [`registro_generacion_conjunto_A.md`](../06_Experimento/prompts_llm/registro_generacion_conjunto_A.md) |
| 7 | 2026-09-14 | El tamano del efecto deja de calcularse sobre las tres medias por juez y pasa a calcularse con el requisito como unidad (25 frente a 26): g de Hedges o delta de Cliff con IC 95 % por bootstrap estratificado. El contraste apareado preregistrado no cambia. Desde la misma fecha, `efectos.csv` declara los pares efectivos (`n_pares`) y si el intervalo es interpretable (`interpretable`), y el deposito de Zenodo, anterior, conserva los efectos retirados | Con n = 3 el bootstrap del efecto apareado producia intervalos sin sentido, como [−42,72 ; 0,00]; el registro previo pide el intervalo «siempre que sea aplicable», y sobre tres observaciones no lo es. Observacion del docente en la evaluacion del 2026-09-14. Ningun valor p ni ninguna conclusion cambian | [`desviacion_tamano_efecto.md`](../06_Experimento/registro_previo/desviacion_tamano_efecto.md) |
