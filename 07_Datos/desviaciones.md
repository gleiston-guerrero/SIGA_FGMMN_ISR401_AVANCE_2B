...
| 7 | 2026-09-14 | El tamano del efecto deja de calcularse sobre las tres medias por juez y pasa a calcularse con el requisito como unidad (25 frente a 26): g de Hedges o delta de Cliff con IC 95 % por bootstrap estratificado. El contraste apareado preregistrado no cambia | Con n = 3 el bootstrap del efecto apareado producia intervalos sin sentido, como [−42,72 ; 0,00]; el registro previo pide el intervalo «siempre que sea aplicable», y sobre tres observaciones no lo es. Observacion del docente en la evaluacion del 2026-09-14. Ningun valor p ni ninguna conclusion cambian | [`desviacion_tamano_efecto.md`](../06_Experimento/registro_previo/desviacion_tamano_efecto.md) |
